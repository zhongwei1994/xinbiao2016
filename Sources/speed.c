...
{
	if(leftSpeed>=0) {EMIOS_0.CH[21].CBDR.R = leftSpeed;EMIOS_0.CH[22].CBDR.R =0;}
		else {EMIOS_0.CH[21].CBDR.R = 0;EMIOS_0.CH[22].CBDR.R = -leftSpeed;}//左轮  E5左退   E6左进
	if(rightSpeed>=0) {EMIOS_0.CH[19].CBDR.R = 0;EMIOS_0.CH[20].CBDR.R = rightSpeed;}
		else {EMIOS_0.CH[19].CBDR.R = -rightSpeed;EMIOS_0.CH[20].CBDR.R = 0;}//右轮  E3右进   E4右退
}
/*************************速度控制函数*********************/
