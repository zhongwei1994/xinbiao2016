...
int cyclespeed=110,turnspeed=130,straightspeed=190,cyclespeedleft=125,cyclespeedright=100;
...
double Speed_kp_Left=10,Speed_ki_Left=0.6,Speed_kd_Left=0;
double Speed_kp_Right=10
