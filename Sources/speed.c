...
int cyclespeed=150,turnspeed=150,straightspeed=270,cyclespeedleft=160,cyclespeedright=122;
...
double Speed_kp_Right=12
		,Speed_ki_Right=0.85,Speed_kd_Right=0;	//电机PID
/*************************电机接口函数*********************/
