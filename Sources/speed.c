...
int cyclespeed=140,turnspeed=150,straightspeed=170,cyclespeedleft=115,cyclespeedright=95;
...
double Speed_kp_Left=4,Speed_ki_Left=0.6,Speed_kd_Left=0;
double Speed_kp_Right=4,Speed_ki_Right=0.85,Speed_kd_Right=0;	//电机PID
/*************************电机接口函数*********************/
