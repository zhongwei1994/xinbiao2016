...
int cyclespeed=110,turnspeed=140,straightspeed=190,cyclespeedleft=125,cyclespeedright=100;
...
double Speed_kp_Left=12,Speed_ki_Left=0.6,Speed_kd_Left=0;
double Speed_kp_Right=12,Speed_ki_Right=0.85,Speed_kd_Right=0;	//电机PID
/*************************电机接口函数*********************/
