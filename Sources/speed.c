...
int cyclespeed=140,turnspeed=140,straightspeed=200,cyclespeedleft=140,cyclespeedright=100;
...
double Speed_kp_Left=8,Speed_ki_Left=0.6,Speed_kd_Left=0;
double Speed_kp_Right=8,Speed_ki_Right=0.85,Speed_kd_Right=0;	//电机PID
/*************************电机接口函数*********************/
